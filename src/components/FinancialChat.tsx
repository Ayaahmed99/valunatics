      ...
      <div className="bg-white border-t border-slate-200 p-4">
        ...
        <div className="flex gap-3">
          <input
            ...
            disabled={loading}
            className="flex-1 px-4 py-3 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:bg-slate-100 text-sm bg-white text-slate-900"
          />
          <button
            onClick={handleSend}
